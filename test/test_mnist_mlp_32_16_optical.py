"""Evaluate 2-hidden-layer MLP (32,16) with optical matmul on MNIST test split.
...
def parse_args() -> argparse.Namespace:
    """定义命令行参数。"""
    parser = argparse.ArgumentParser(description="Evaluate MNIST MLP (32,16) with optical matmul")
    parser.add_argument(
        "--checkpoint",
        type=str,
        default="models/mnist_mlp_32_16/best_mnist_mlp_32_16.pt",
